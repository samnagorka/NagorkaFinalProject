...
Slow.prototype.act = function(step) {
  this.wobble += step * wobbleSpeed;
  var wobblePos = Math.cos(this.wobble) * .02;
  this.pos = this.basePos.plus(new Vector(0, wobblePos));
};
...
Trick.prototype.act = function(step) {
...
function runLevel(level, Display, andThen) {
  ...
  runAnimation(function(step) {
    ...
    if (level.isFinished()) {
		alert ("If you completed the level and collected all the gold coins, you will advance! If not, please try again!");
      display.clear();
